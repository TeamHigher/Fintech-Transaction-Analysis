--================================================
-- PROJECT: Fintech Transaction Analysis
-- AUTHOR: Uwabuofu Chukuka
-- TOOL: SQL Server (SSMS)
-- DATASET: 5,000 transactions, 1,000 users
-- DATE: June 2025
-- DESCRIPTION: Analysis of a Nigerian fintech 
-- platform to uncover revenue patterns, user 
-- behaviour and platform performance insights
--================================================
