...
one-third of transactions complete successfully. This suggests potential inefficiencies in the transaction 
pipeline and highlights an opportunity to improve system reliability and completion rates.*/
...
--Question 6 — the final one: What is the average transaction fee rate by currency?--
SELECT 
    currency,
    COUNT(*) AS transaction_count,
    ROUND(AVG(amount), 2) AS avg_transaction_value,
